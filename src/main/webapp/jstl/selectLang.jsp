...
<script>
	$(document).ready(function(){
		...
		$("select").val("${select}");
		// = $('#select > option[value=${select}]').prop('selected','true');
...
<%-- 
 ...
 --%>
	<form id="frm" action=" ${pageContext.servletContext.contextPath}/selectLang" method="get">		
