...
public class UserPagingListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//page, pageSize에 해당하는 파라미터 받기 ==> pageVo객체에 받아야함
		...
		//userPaging를 화면으로 출력할 jsp로 위임(forward)
		request.getRequestDispatcher(request.getContextPath()+"/user/userPagingList.jsp")
